...
export function EssayPage() {
  ...
  // Audio upload + TTS đã chuyển sang /episodes (EpisodeList + EpisodeEdit
  // tab Kịch bản). Essay chỉ focus viết nội dung + suggest references.
    ...
    <div className="container max-w-7xl py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
        ...
        <div className="space-y-4">
          ...
          {/* Audio TTS + upload NotebookLM — đã chuyển sang /episodes (tab
              Kịch bản dùng Gemini 2 voice; upload audio sẵn ở EpisodeList). */}
        </div>
      </div>
    </div>
  );
