...
export const SCENE_CATALOG: SceneCatalogEntry[] = [
  ...
  },
  {
    ...
    description: "Đồng hồ cát + dòng chảy — thời gian trôi, vô thường (Heraclitus).",
    stickers: ["Hourglass"],
    doodles: ["Squiggle", "StarSmall", "Sparkle"],
    keywords: ["thời gian", "trôi qua", "khoảnh khắc", "dòng chảy", "quá khứ", "đồng hồ"],
    suggestedMoods: ["contemplative"],
    category: "reflection",
  },
  {
    key: "Wave",
    label: "Sóng vô thường",
    description: "Sóng biển cuộn — cái tôi tan biến, phù du, buông.",
    stickers: ["Wave"],
    doodles: ["Squiggle", "StarSmall", "Sparkle"],
    keywords: ["con sóng", "sóng biển", "tan biến", "phù du", "biển cả", "trôi đi"],
    suggestedMoods: ["healing"],
    category: "calm",
  },
  {
    key: "Cosmos",
    label: "Vũ trụ bao la",
    description: "Hành tinh có vành + sao — con người nhỏ bé, choáng ngợp.",
    stickers: ["Planet"],
    doodles: ["StarSmall", "Sparkle"],
    keywords: ["vũ trụ", "bao la", "nhỏ bé", "vì sao", "không gian", "vô tận"],
    suggestedMoods: ["contemplative"],
    category: "reflection",
  },
  {
    key: "Labyrinth",
    label: "Mê cung",
    description: "Mê cung + dấu hỏi — lạc lối, rối ren, hoang mang.",
    stickers: ["Maze", "QuestionMark"],
    doodles: ["DottedPath", "StarSmall"],
    keywords: ["lạc lối", "rối ren", "phức tạp", "mê cung", "hoang mang", "bế tắc"],
    suggestedMoods: ["contemplative"],
    category: "thought",
  },
  {
    key: "Burden",
    label: "Gánh nặng",
    description: "Khối đá nặng + mũi tên đè — trách nhiệm, áp lực, đè nén.",
    stickers: ["Weight"],
    doodles: ["StarSmall", "Sparkle"],
    keywords: ["gánh nặng", "trách nhiệm", "áp lực", "mang vác", "nặng nề", "đè nén"],
    suggestedMoods: ["contemplative"],
    category: "emotion",
  },
  {
    key: "Fate",
    label: "Định mệnh",
    description: "Domino dây chuyền — nhân quả, tất yếu, an bài.",
    stickers: ["Dominoes"],
    doodles: ["Arrow", "StarSmall", "Sparkle"],
    keywords: ["định mệnh", "số phận", "nhân quả", "tất yếu", "an bài", "quy luật"],
    suggestedMoods: ["contemplative"],
    category: "thought",
  },
  {
    key: "Enlightenment",
    label: "Khai sáng",
    description: "Mặt trời tia sáng + bóng đèn — giác ngộ, lý trí bừng lên.",
    stickers: ["Sunburst", "Lightbulb"],
    doodles: ["Sparkle", "StarSmall"],
    keywords: ["khai sáng", "giác ngộ", "ánh sáng", "soi rọi", "bừng sáng", "lý trí"],
    suggestedMoods: ["energetic", "positive"],
    category: "thought",
  },
  {
    key: "Paradox",
    label: "Nghịch lý",
    description: "Hai vòng lồng + mũi tên ngược — mâu thuẫn, trái ngược.",
    stickers: ["Knot", "QuestionMark"],
    doodles: ["Arrow", "StarSmall"],
    keywords: ["nghịch lý", "mâu thuẫn", "trái ngược", "oái oăm", "đối nghịch"],
    suggestedMoods: ["contemplative"],
    category: "thought",
  },
  {
    key: "BrokenChains",
    label: "Phá xiềng",
    description: "Xích đứt — tự do, giải phóng, bứt phá.",
    stickers: ["BrokenChain"],
    doodles: ["Sparkle", "StarSmall", "Confetti"],
    keywords: ["tự do", "giải phóng", "xiềng xích", "ràng buộc", "bứt phá", "tự chủ"],
